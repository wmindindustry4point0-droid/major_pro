...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setError('');
        try {
            const res = await axios.post('https://hiremind-ai-4k68.onrender.com/api/auth/login', formData);
                ...
                <div className="backdrop-blur-xl bg-white/10 p-8 sm:p-10 rounded-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] border border-white/20">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold py-3.5 px-4 rounded-xl hover:from-purple-500 hover:to-indigo-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-slate-900 transition-all transform hover:-translate-y-0.5 shadow-lg shadow-purple-500/30 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none"
                        >
                    ...
                    <p className="mt-8 text-center text-sm text-gray-400">
                        ...
                        <Link to="/register" className="font-semibold text-purple-300 hover:text-white transition-colors duration-200 ml-1">
                            Sign up here
                        </Link>
                    </p>
                </div>
