...
import { UploadCloud, FileText, CheckCircle2, Loader2, User, Mail, Phone, MapPin, Briefcase, GraduationCap, Activity } from 'lucide-react';
...
const ResumeProfile = () => {
    ...
    const handleUpload = async (file) => {
        ...
        try {
            const res = await axios.post(`${import.meta.env.VITE_API_URL || "http://localhost:5000"}/api/candidate/profile`, formData, {
    ...
    return (
        <div className="space-y-8 pb-12">
            ...
            >
                ...
                <input type="file" accept=".pdf" className="hidden" ref={fileInputRef} onChange={(e) => { if (e.target.files[0]) handleUpload(e.target.files[0]); }} />
